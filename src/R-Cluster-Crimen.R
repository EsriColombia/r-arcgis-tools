...
data <- arc.select (object = d, c('WIDTH', 'HEIGHT','OBJECTID'), where_clause = "WIDTH > 25 AND HEIGHT > 11")
...
arc.write("c:/EsriTraining/R-ArcGISBridge/data.gdb/billboard_clusters", arc.df)
